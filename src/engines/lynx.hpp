...
public:
    ...
    static parameters_t get_initial_parameters()
    {
        ...
        assert(TotalKingRingAttacksBonus.tunableSize == 9);    // [5..13]
...
EvalResult Lynx::get_external_eval_result(const chess::Board &board)
{
    ...
    const auto totalKingRingWhiteAttacks = std::clamp(totalKingRingAttacks[static_cast<int>(chess::Color::WHITE)], 5, 13);
    ...
    const auto totalKingRingBlackAttacks = std::clamp(totalKingRingAttacks[static_cast<int>(chess::Color::BLACK)], 5, 13);
